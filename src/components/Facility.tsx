      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-extrabold mb-4">A World-Class Facility</h2>
            <p className="text-slate-600">Clean, secure, and designed for optimal dog comfort and learning.</p>
          </motion.div>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="hidden md:block bg-slate-900 text-white px-6 py-3 rounded-lg font-bold text-sm"
          >
            View Full Gallery
          </motion.button>
        </div>
