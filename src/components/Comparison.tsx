        ...
        >
          <table className="w-full text-left">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                <th className="px-8 py-6 text-sm font-bold uppercase tracking-wider">Features</th>
            ...
            <tbody className="divide-y divide-slate-100">
              {features.map((feature, index) => (
                ...
                >
                  <td className="px-8 py-6 font-medium">{feature.name}</td>
                  <td className="px-8 py-6 text-slate-500">{feature.typical}</td>
                  <td className="px-8 py-6 font-bold flex items-center gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-500" /> {feature.greendog}
                  </td>
                </motion.tr>
              ))}
            </tbody>
